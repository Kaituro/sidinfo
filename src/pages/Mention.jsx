const Mention = () => {
    ...
    return (
      <div className="conteneur_mention">
        <p><span>Éditeur du Site :</span>  Equipe Champ.py nuit de l'informatique 2022
<br />
<span>Responsable éditorial :</span>  Valentin Merrault
<br />
<span>Email : </span> jorivi500@gmail.com</p>
        <p><span>Hébergement :</span> 
<br />
<span>Hébergeur :</span>  
<br />
<span>Développement :</span> Valentin Merrault et Josian Riviere equipe Champ.py nuit de l'informatique 2022</p>

        <p><span>Conditions d’utilisation :</span> 
<br />
...
<br /> Les sites internet de peuvent offrir des liens vers d’autres sites internet ou d’autres ressources disponibles sur Internet. Nous ne disposons d’aucun moyen pour contrôler les sites en connexion avec ses sites internet.
<br />
...
De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant pas de virus et avec un navigateur de dernière génération mis-à-jour.
        ...
        <p><span>Déclaration à la CNIL :</span> 
<br />
